...
const FishCollagenApplications = () => {
      ...
      <main>
        ...
        >
          <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20">
            ...
            <div className="relative z-10 text-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <section className="py-12 bg-background">
            <div className="container mx-auto px-4 sm:px-6 md:px-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8" style={{ fontFamily: 'Inter', color: 'rgba(29, 129, 165, 1)', fontWeight: '500' }}>
                {t('fishCollagen.productShowcase.usageTitle')}
              </h2>
                ...
                {categories.map((category) => (
                  <div key={category.id} className="bg-white rounded-lg shadow-lg p-6">
                    <div className="mb-4 flex justify-center">
                      <img
                        src={`/images/Fish_Collagen_Peptide/${getCategoryImageName(category.id)}.png`}
                        alt={category.name}
                    ...
                    >
                      {t('fishCollagen.productShowcase.discoverMore')}
          ...
          <section className="py-12 md:py-20 bg-background">
            <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-6 items-center">
                ...
                >
                  <h2 className="mb-4 md:mb-8" style={{ fontFamily: 'Inter', color: 'rgba(29, 129, 165, 1)', fontSize: window.innerWidth < 768 ? '24px' : window.innerWidth < 1024 ? '32px' : '40px', fontWeight: '500' }}>{t('fishCollagen.insights.title')}</h2>
                  <img
                    src="/images/insight_1.png"
                    alt="Fish Collagen Insights"
                ...
                >
                  <h2 className="mb-4 md:mb-8" style={{ fontFamily: 'Inter', color: 'rgba(29, 129, 165, 1)', fontSize: window.innerWidth < 768 ? '24px' : window.innerWidth < 1024 ? '32px' : '40px', fontWeight: '500' }}>{t('fishCollagen.insights.whatIsTitle')}</h2>
                  <div className="space-y-4 md:space-y-6">
                    {(t('fishCollagen.insights.items', { returnObjects: true }) as string[]).map((item: string, index: number) => (
                      <div key={index} className="flex items-start space-x-3 md:space-x-4">
                        <img
                          src={`/images/pin${index + 1}.png`}
                          alt={`Icon ${index + 1}`}
                          className="w-5 h-5 md:w-6 md:h-6 flex-shrink-0 mt-1 object-contain"
                        />
                  ...
                  <div className="mt-8">
                    <Button 
                      variant="outline" 
                      onClick={() => navigate('/fish-collagen-peptide')}
...
export default FishCollagenApplications;
